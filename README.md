...
### 4. 어려웠던 점
    처음으로 오픈소스 라이브러리를(powermenu) 사용했는데 guide를 보고 진행했음에도 menu를 생성하는 작업이 잘 안되었음
    -> code clone해서 작업 및 context에 대해 학습 진행
    ...
    2가지 사항 진행해도 해결 못함 -> '안드로이드 개발 Q&A 및 팁'방에 질문해 도움을 얻고 View에 대해 학습 진행
