...
object PowerMenuUtils {
    ...
    fun getHamburgerPowerMenu(
        ...
        return PowerMenu.Builder(context!!)
            .addItem(PowerMenuItem("Friend Mode", true))
            .addItem(PowerMenuItem("Secret Mode", false))
            .addItem(PowerMenuItem("Gallery Mode", false))
            .setAutoDismiss(true)
            ...
            .setInitializeRule(
                ...
                0
            ) // Lifecycle.Event and default position.
            .build()
    }
}
